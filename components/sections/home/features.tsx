    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center">
          <button className="mt-8 text-indigo-600 border-2 border-indigo-600 hover:bg-indigo-100 font-semibold px-6 py-2 rounded-sm transition duration-300 cursor-pointer">
            Show 3 more
          </button>
        </div>
      </div>
